<script setup>
    ...
    const emit = defineEmits(['cancel', 'upload', 'copy', 'download'])
</script>
...
<template>
    <div class="fixed inset-0 flex flex-col">
                ...
                <div class="relative flex-1 overflow-hidden rounded-2xl bg-black">
                    ...
                    <div
                        ...
                        <div class="text-center">
                            ...
                            <small
                                v-if="isDownloading"
                                class="mt-1 block text-sm text-white/70"
                                >Please wait...</small
                            >
                            <small
                                v-else
                                class="mt-1 block text-sm text-white/70"
                                >Fixing duration metadata</small
                            >
                        </div>
                    </div>
                </div>
        ...
        <div
            ...
            class="mt-4 flex shrink-0 items-center gap-4 transition-shadow">
