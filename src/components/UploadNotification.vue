...
<template>
    <div>
        ...
        <div class="mb-5 flex items-center gap-4">
            ...
            <h2 class="font-bold dark:text-white">{{ statusText }}</h2>
        ...
        <template
            ...
            <!-- Progress Bar -->
            <div class="relative mt-2 h-1.5 w-full overflow-hidden rounded-full bg-slate-200 dark:bg-slate-700">
                <div
                    v-if="status !== 'error'"
        ...
        <template v-if="status === 'success'">
            <div class="flex gap-2 pb-4">
                <div
                    class="dark:border-dark-700 dark:bg-dark-800 flex-1 truncate rounded-lg border border-slate-200 bg-slate-100 px-3 py-1 text-sm text-blue-500 dark:text-blue-400">
                    {{ link }}
                </div>
