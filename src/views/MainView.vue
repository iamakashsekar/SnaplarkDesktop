        ...
        <div class="main-container dark:bg-dark-blue flex h-full w-full flex-col rounded-2xl bg-white px-4 py-6">
            ...
            <div class="space-y-2">
                <Tooltip :text="store.settings.showTooltips ? displayHotkeyScreenshot : ''">
                    <button type="button" @click="takeScreenshot"
                        ...
                        <svg width="28" height="25" viewBox="0 0 28 25" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <rect x="4.73857" y="0.876263" width="22.3854" height="22.3854" stroke="#2178FF"
                                stroke-width="1.75253" stroke-dasharray="10.52 10.52" />
                            <path
                ...
                <Tooltip :text="store.settings.showTooltips ? displayHotkeyRecording : ''">
                    <button type="button" @click="recordVideo()"
                        class="dark:hover:bg-dark-800 group flex w-full cursor-pointer items-center gap-6 rounded-lg px-2.5 py-1.5 text-gray-700 transition-colors hover:bg-gray-200/10 dark:text-gray-200">
            ...
            <div class="space-y-2">
                <Tooltip
                    :text="store.settings.showTooltips ? (store.lastCapture ? 'Open last uploaded capture' : 'No capture uploaded yet') : ''">
                    <button :disabled="!store.lastCapture" type="button" @click="openLastCapture"
                        ...
                        <svg width="29" height="29" viewBox="0 0 29 29" fill="none" xmlns="http://www.w3.org/2000/svg">
                            ...
                            <path
                                ...
                                stroke="#2178FF" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" />
                            <path d="M2.41699 14.5C2.41699 21.17 7.83033 26.5833 14.5003 26.5833" stroke="#2178FF"
                ...
                <button type="button" @click="uploadMedia"
                    ...
                    <svg width="29" height="29" viewBox="0 0 29 29" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <path
                            ...
                            fill="#2178FF" />
                        <path d="M14.5 19.75L14.5 11.7" stroke="white" stroke-width="1.0625" stroke-linecap="round"
                            stroke-linejoin="round" />
                        <path d="M12.4062 13.0937L14.5 11L16.5938 13.0938" stroke="white" stroke-width="1.0625"
                ...
                <button type="button" @click="viewUploadedHistory"
                    class="dark:hover:bg-dark-800 group flex w-full cursor-pointer items-center gap-6 rounded-lg px-2.5 py-1.5 text-gray-700 transition-colors hover:bg-gray-200/10 dark:text-gray-200">
                    <svg width="29" height="29" viewBox="0 0 29 29" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <path
                            ...
                            fill="#2178FF" />
                        <path d="M14.5 17.2158L14.5 13.052" stroke="white" stroke-width="0.549569"
                            stroke-linecap="round" stroke-linejoin="round" />
                        <path d="M13.4161 13.7729L14.4991 12.6899L15.582 13.7729" stroke="white" stroke-width="0.549569"
                            stroke-linecap="round" stroke-linejoin="round" />
                        <path d="M2.41699 9.13501H4.84574H7.78199" fill="#2178FF" />
                        <path
                            d="M17.5816 26.1846C22.7653 24.8192 26.5837 20.1067 26.5837 14.5C26.5837 7.83001 21.2187 2.41667 14.5003 2.41667C6.44074 2.41667 2.41699 9.13501 2.41699 9.13501M2.41699 9.13501V3.62501M2.41699 9.13501H4.84574H7.78199"
            ...
            <div class="space-y-4">
                <Tooltip
                    :text="store.settings.showTooltips ? `${store.getOs() === 'darwin' ? 'Quit' : 'Close'} (${store.getOs() === 'darwin' ? 'Cmd' : 'Ctrl'} + Q)` : ''">
                    <button type="button" @click="quitApplication"
                        class="dark:hover:bg-dark-800 group flex w-full cursor-pointer items-center gap-6 rounded-lg px-2.5 py-1.5 text-gray-700 transition-colors hover:bg-gray-200/10 dark:text-gray-200">
                        <svg width="29" height="29" viewBox="0 0 29 29" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <path
                ...
                <!-- User Profile -->
                <div ref="userMenuContainer" class="relative flex items-center gap-3 rounded-2xl px-2.5 py-1.5">
                    <img class="ring-primary-blue h-10 w-10 cursor-pointer rounded-full object-cover shadow-lg ring-2"
                        @click="visitProfile" :src="store.user?.profile_photo_url" alt="User avatar" />
