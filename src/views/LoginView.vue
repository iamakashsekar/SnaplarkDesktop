...
const handleLogin = async () => {
  ...
  const loginUrl = `${WEB_URLS.BASE_URL}/auth/client?callback_protocol=${
    API_CONFIG.PROTOCOL
...
const handleRegister = async () => {
  const deviceName = await window.electron.getDeviceName();
  const registerUrl = `${WEB_URLS.BASE_URL}/auth/client?callback_protocol=${
    API_CONFIG.PROTOCOL
...
const { latestPost, fetchLatestPost } = useBlog();
...
<template>
  <div
    class="login-container min-w-[400px] bg-linear-to-r from-blue-500 to-cyan-500 pt-2 rounded-2xl select-none"
  >
    <div class="bg-white px-2 py-3 dark:bg-dark-blue space-y-6 rounded-2xl">
      <div class="space-y-6 w-3/4 mx-auto">
        <div class="text-center pt-7">
          <h1 class="text-gray-black dark:text-white mb-2 text-2xl font-bold">
        ...
        <div class="space-y-3">
          ...
          <button
            ...
            class="w-full rounded-full border-2 border-primary-blue bg-white px-6 py-3 text-base font-semibold text-primary-blue transition-all duration-200 hover:bg-blue-50 dark:bg-dark-800 dark:hover:bg-dark-700 disabled:opacity-50 disabled:cursor-not-allowed"
          >
          ...
          <button
            ...
            :disabled="store.isLoading"
            class="w-full rounded-full bg-primary-blue px-6 py-3 text-base font-semibold text-white transition-all duration-200 hover:bg-blue-600 disabled:opacity-50 disabled:cursor-not-allowed"
          >
            <span v-if="store.isLoading">Loading...</span>
        ...
        <div class="space-y-1.5 text-center">
          ...
          <button
            ...
            class="w-full rounded-full bg-gray-100 px-6 py-3 text-base font-semibold text-gray-700 transition-all duration-200 hover:bg-gray-200 dark:bg-dark-700 dark:text-gray-300 dark:hover:bg-dark-600"
          >
            Guest
          </button>
        </div>
      ...
      >
        ...
        <Carousel v-bind="carouselConfig">
          ...
          <Slide>
            <div class="space-y-6 px-6 pt-5 text-white">
              ...
              <div class="mb-5 space-y-1">
                ...
                <p class="text-xs">
                  check out the latest updates on Snaplark blog
                </p>
              </div>
              ...
              <div class="space-y-2.5">
                ...
                <div
                  v-if="latestPost"
                  class="flex items-center gap-3 rounded-xl bg-white dark:bg-dark-900 p-2 cursor-pointer hover:bg-gray-50 dark:hover:bg-dark-800 transition-colors"
                  @click="
                    store.openExternal(
                      `https://snaplark.com/blog/${latestPost.slug}`
                    )
                  "
                >
                  <img
                    v-if="latestPost.thumb_url"
                    class="h-[93px] w-1/2 object-cover rounded-lg"
                  ...
                  <div
                    v-else
                    class="h-[93px] w-1/2 bg-gradient-to-br from-blue-400 to-cyan-400 rounded-lg flex items-center justify-center"
                  >
                  ...
                  <div class="flex-1">
                    <p
                      class="text-gray-black dark:text-white text-sm font-bold line-clamp-3"
                    >
                ...
                <div
                  ...
                  class="flex items-center gap-3 rounded-xl bg-white dark:bg-dark-900 p-2 cursor-pointer"
                >
                  <div
                    class="h-[93px] w-1/2 bg-gradient-to-br from-blue-400 to-cyan-400 rounded-lg flex items-center justify-center"
                  >
                  ...
                  <p class="text-gray-black dark:text-white text-sm font-bold">
                    Welcome to Snaplark! Check out our blog for the latest
          ...
          <Slide>
            <div class="space-y-6 px-6 pt-5 text-white">
              ...
              <div class="mb-5 space-y-1">
                ...
                <p class="text-xs">
                  Are you overwhelmed by the number of available options? Use
                  lightweight mode to disable resource-intensive features and
                  improve performance
                </p>
              </div>

              <img
                class="h-auto w-3/5 mx-auto"
          ...
          <!-- Did you know? -->
          <Slide>
            <div class="space-y-6 px-6 pt-5 text-white w-full">
              <!-- Header -->
              <div class="mb-5 space-y-1">
                <h2 class="text-[28px] font-bold">Did you know?</h2>
                <p class="text-xs">
                  Having multi monitors? Snaplark covers them all!
                </p>
              </div>
              <img
                class="w-46 mx-auto"
        ...
        <!-- Footer Links -->
        <div
          class="flex mt-6 justify-between gap-1 border-t border-white/50 px-6 py-4 text-white"
        >
          <a
